...
export default function CardShopBusinessPlan() {
  ...
  const grandCapital = boxCost + (shippingCost * packsPerBox) + totalSourceCost + (bundleShipping * bundlesPerCase) + mfbTotalInv;
  const grandProfitBest = totalProfit + bundleTotalProfit + mfbBestProfit;
  const grandProfitWorst = totalProfit + bundleTotalProfit + mfbWorstProfit;
  const grandProfitExpected = totalProfit + bundleTotalProfit + mfbExpectedProfit;
    ...
    >
      ...
      <div style={{ textAlign: "center", marginBottom: 36 }}>
        ...
        <div style={{ fontSize: 13, color: COLORS.muted }}>
          3 Active Investments · MTG · Pokémon · Supplies
        </div>
      </div>
      ...
      <Section title="Action Steps" icon="✅">
        <div style={{ fontSize: 13, color: COLORS.muted, lineHeight: 1.9 }}>
          {[
            ...
            "Create all eBay listings — booster packs, bundles, sealed product, singles",
            "Ship sealed/bundles via USPS Ground Advantage · singles via eBay Standard Envelope",
